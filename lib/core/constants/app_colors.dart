...
class AppColors {
  ...
  static const Color primary60  = Color(0xFFAAD3CA);
  static const Color primary40  = Color(0xFFD8EBE7);
  ...
  static const Color secondary60  = Color(0xFFFFB44D);
  ...
  // Warning
  static const Color warning = Color(0xFFE04E00);
  static const Color warningLight = Color(0xFFF95E00);
